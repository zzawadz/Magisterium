...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm, height=100mm]{wykresy/cross}
  \caption{BRN}
  \label{fig:Cross}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm, height=100mm]{wykresy/relacjaBIDASK}
  \caption{BRN}
  \label{fig:JUMP}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm, height=100mm]{wykresy/nextout}
  \caption{BRN}
  \label{fig:NEXTOUT}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm, height=100mm]{wykresy/longStreak}
  \caption{BRN}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm, height=100mm]{wykresy/longTime}
  \caption{BRN}
  \label{fig:longTime}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm, height=100mm]{wykresy/spreadJump}
  \caption{BRN}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm, height=100mm]{wykresy/outSeries}
  \caption{BRN}
  \label{fig:outSeries}
\end{figure}
