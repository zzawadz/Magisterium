...
Filtr generalnie dobrze radzi sobie w przypadkach w których obserwacje odstające pojawiają się pojedynczo (por. rys. \ref{fig:ojfh10}), natomiast w zupełności nie radzi sobie w przypadku poziomych i pionowych ścieżek obserwacji odstających (por. rys. \ref{fig:fzwh11}). Co więcej występowanie ścieżek obserwacji odstających w dużym stopniu zaburza wskazania wskaźnika TPR.
